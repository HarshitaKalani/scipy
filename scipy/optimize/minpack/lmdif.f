      recursive
     *subroutine lmdif_(fcn,m,n,x,fvec,ftol,xtol,gtol,maxfev,epsfcn,
...
c
         iflag = 2
         call fdjac2_(fcn,m,n,x,fvec,fjac,ldfjac,iflag,epsfcn,wa4)
         nfev = nfev + n
         if (iflag .lt. 0) go to 300
c
...
c
         call qrfac_(m,n,fjac,ldfjac,.true.,ipvt,n,wa1,wa2,wa3)
c
