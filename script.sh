# iterate over all files of scipy/optimize/minpack/ and
...
for src in $(find /home/harshita/scipy/scipy/optimize/minpack/ -name "*.f"); do
    echo "Compiling $src"
    lfortran -c $src -o ${src%.f}.o --fixed-form --implicit-typing --implicit-interface --generate-object-code --use-loop-variable-after-loop --all-mangling --mangle-underscore
    cp ${src%.f}.o ./
done

lfortran -c /home/harshita/scipy/scipy/optimize/minpack/chkder.f -o chkder.o --fixed-form --implicit-typing --implicit-interface --generate-object-code --use-loop-variable-after-loop --rtlib --all-mangling --mangle-underscore
